            ...
            <div className="">
                {
                    list.map((news, index) => {
                        return (
                            <a key={index} href="#" className="flex flex-col items-center mb-5 bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-max hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
