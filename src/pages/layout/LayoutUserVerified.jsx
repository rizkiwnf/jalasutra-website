...
const LayoutUserVerified = () => {
    ...
    return (
        <main>
            {/* <div className="fixed top-10 start-10 group"> */}
            <div className="fixed top-10 start-10 group flex flex-col gap-2">
                <button className="flex items-center justify-center text-white bg-blue-700 rounded-full w-14 h-14 hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800">
                ...
                <button type="button" className="flex justify-center items-center w-[52px] h-[52px] text-gray-500 hover:text-gray-900 bg-white rounded-full border border-gray-200 dark:border-gray-600 shadow-sm dark:hover:text-white dark:text-gray-400 hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-gray-600 focus:ring-4 focus:ring-gray-300 focus:outline-none dark:focus:ring-gray-400">
                    <img className="w-8 h-8 rounded-full" src={profile.foto} alt="user"></img>
            ...
            {/* <div data-dial-init className="fixed top-10 start-10 group">
                ...
                <div id="speed-dial-menu-top-left" className="flex flex-col items-center hidden mt-4 space-y-2">
                    ...
                    <button type="button" data-tooltip-target="tooltip-profile" data-tooltip-placement="left" className="flex justify-center items-center w-[52px] h-[52px] text-gray-500 hover:text-gray-900 bg-white rounded-full border border-gray-200 dark:border-gray-600 shadow-sm dark:hover:text-white dark:text-gray-400 hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-gray-600 focus:ring-4 focus:ring-gray-300 focus:outline-none dark:focus:ring-gray-400">
                        <img className="w-8 h-8 rounded-full" src={profile.photo} alt="user"></img>
                        <span className="sr-only">Profile</span>
                    </button>
