                                ...
                                DATA_PENGAJUAN.map((data, index) => (
                                    <tr className="bg-white border-b text-black" key={index}>
                                        ...
                                        <td className="flex flex-wrap px-6 py-4 items-center gap-2 text-xl">
                                            <Link to="/admin/mail/submission/detail" className="px-2.5 py-2 text-xs font-medium text-center inline-flex items-center text-white bg-blue-600 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
